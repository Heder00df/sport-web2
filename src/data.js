...
import futList from './images/svg/football-list.svg';
...
const data = {
  ...
  tableEquipes: {
    equipes: [
      {id: 1, descricao: 'Product 1'},
      {id: 2, descricao: 'Product 2'},
      {id: 3, descricao: 'Product 3'},
      {id: 4, descricao: 'Product 4'},
      {id: 5, descricao: 'Product 5'},
      {id: 6, descricao: 'Product 6'},
    ]
  },
  dashBoardPage: {
    recentProducts: [
